...
################################################################################
## Form generated from reading UI file 'psd_settings.ui'
##
...
class Ui_DockWidget_psd(object):
    def setupUi(self, DockWidget_psd):
        if not DockWidget_psd.objectName():
            DockWidget_psd.setObjectName(u"DockWidget_psd")
        DockWidget_psd.resize(852, 762)
        self.dockWidgetContents = QWidget()
        self.dockWidgetContents.setObjectName(u"dockWidgetContents")
        self.gridLayout_3 = QGridLayout(self.dockWidgetContents)
        self.gridLayout_3.setObjectName(u"gridLayout_3")
        self.pushButton_configure_psd = QPushButton(self.dockWidgetContents)
        self.pushButton_configure_psd.setObjectName(u"pushButton_configure_psd")

        self.gridLayout_3.addWidget(self.pushButton_configure_psd, 6, 0, 1, 1)

        self.horizontalGroupBox_5 = QGroupBox(self.dockWidgetContents)
        ...
        sizePolicy.setHeightForWidth(self.comboBox_psd_delay_range_c.sizePolicy().hasHeightForWidth())
        self.comboBox_psd_delay_range_c.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHeightForWidth(self.comboBox_psd_width_range_c.sizePolicy().hasHeightForWidth())
        self.comboBox_psd_width_range_c.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHeightForWidth(self.comboBox_psd_delay_range_b.sizePolicy().hasHeightForWidth())
        self.comboBox_psd_delay_range_b.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHeightForWidth(self.comboBox_psd_width_range_b.sizePolicy().hasHeightForWidth())
        self.comboBox_psd_width_range_b.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHeightForWidth(self.comboBox_psd_delay_range_a.sizePolicy().hasHeightForWidth())
        self.comboBox_psd_delay_range_a.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHeightForWidth(self.comboBox_psd_width_range_a.sizePolicy().hasHeightForWidth())
        self.comboBox_psd_width_range_a.setSizePolicy(sizePolicy)
        ...
        self.gridLayout_3.addWidget(self.horizontalGroupBox_5, 5, 0, 1, 6)

        self.pushButton_reset_psd = QPushButton(self.dockWidgetContents)
        self.pushButton_reset_psd.setObjectName(u"pushButton_reset_psd")

        self.gridLayout_3.addWidget(self.pushButton_reset_psd, 6, 1, 1, 1)

        self.checkBox_psd_global_enable = QCheckBox(self.dockWidgetContents)
        ...
        self.gridLayout_3.addWidget(self.checkBox_psd_global_enable, 2, 4, 1, 1)
        ...
        self.groupBox_psd_offset_dac = QGroupBox(self.dockWidgetContents)
        ...
        sizePolicy3.setHeightForWidth(self.verticalSlider_psd_single_channel_offset_dac_a.sizePolicy().hasHeightForWidth())
        self.verticalSlider_psd_single_channel_offset_dac_a.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.verticalSlider_psd_single_channel_offset_dac_c.sizePolicy().hasHeightForWidth())
        self.verticalSlider_psd_single_channel_offset_dac_c.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.verticalSlider_psd_single_channel_offset_dac_b.sizePolicy().hasHeightForWidth())
        self.verticalSlider_psd_single_channel_offset_dac_b.setSizePolicy(sizePolicy3)
        ...
        sizePolicy5.setHeightForWidth(self.lineEdit_psd_offset_dac_a.sizePolicy().hasHeightForWidth())
        self.lineEdit_psd_offset_dac_a.setSizePolicy(sizePolicy5)
        ...
        self.gridLayout_3.addWidget(self.verticalGroupBox, 0, 1, 5, 3)

        self.pushButton_continous_octal_dac_update = QPushButton(self.dockWidgetContents)
        ...
        self.gridLayout_3.addWidget(self.pushButton_continous_octal_dac_update, 4, 4, 1, 1)

        self.formLayout_2 = QFormLayout()
        self.formLayout_2.setObjectName(u"formLayout_2")
        self.label_psd_polarity = QLabel(self.dockWidgetContents)
        ...
        self.comboBox_psd_polarity = QComboBox(self.dockWidgetContents)
        ...
        self.label_psd_bias_2 = QLabel(self.dockWidgetContents)
        ...
        self.comboBox_psd_bias = QComboBox(self.dockWidgetContents)
        ...
        self.label_psd_trigger_mode = QLabel(self.dockWidgetContents)
        ...
        self.comboBox_psd_trigger_mode = QComboBox(self.dockWidgetContents)
        ...
        self.label_35 = QLabel(self.dockWidgetContents)
        ...
        self.comboBox_psd_vtc_range = QComboBox(self.dockWidgetContents)
        ...
        self.gridLayout_3.addLayout(self.formLayout_2, 1, 4, 1, 2)

        self.groupBox_psd_test_mode = QGroupBox(self.dockWidgetContents)
        ...
        self.gridLayout_3.addWidget(self.groupBox_psd_test_mode, 0, 4, 1, 2)

        self.pushButton_reset_all_dacs = QPushButton(self.dockWidgetContents)
        self.pushButton_reset_all_dacs.setObjectName(u"pushButton_reset_all_dacs")

        self.gridLayout_3.addWidget(self.pushButton_reset_all_dacs, 4, 5, 1, 1)

        self.pushButton_reset_psd_ui = QPushButton(self.dockWidgetContents)
        self.pushButton_reset_psd_ui.setObjectName(u"pushButton_reset_psd_ui")

        self.gridLayout_3.addWidget(self.pushButton_reset_psd_ui, 3, 4, 1, 2)

        DockWidget_psd.setWidget(self.dockWidgetContents)

        self.retranslateUi(DockWidget_psd)

        QMetaObject.connectSlotsByName(DockWidget_psd)
    # setupUi

    def retranslateUi(self, DockWidget_psd):
        DockWidget_psd.setWindowTitle(QCoreApplication.translate("DockWidget_psd", u"PSD", None))
        self.pushButton_configure_psd.setText(QCoreApplication.translate("DockWidget_psd", u"Configure PSD", None))
        self.horizontalGroupBox_5.setTitle(QCoreApplication.translate("DockWidget_psd", u"Integrator Gates", None))
        self.groupBox_subchannel_C.setTitle("")
        self.label_27.setText(QCoreApplication.translate("DockWidget_psd", u"C", None))
        self.label_psd_gain_a_3.setText(QCoreApplication.translate("DockWidget_psd", u"Gain", None))
        self.comboBox_psd_gain_c.setItemText(0, QCoreApplication.translate("DockWidget_psd", u"500", None))
        self.comboBox_psd_gain_c.setItemText(1, QCoreApplication.translate("DockWidget_psd", u"1000", None))
        self.comboBox_psd_gain_c.setItemText(2, QCoreApplication.translate("DockWidget_psd", u"2000", None))
        self.comboBox_psd_gain_c.setItemText(3, QCoreApplication.translate("DockWidget_psd", u"5000", None))
        self.comboBox_psd_gain_c.setItemText(4, QCoreApplication.translate("DockWidget_psd", u"10000", None))
        self.comboBox_psd_gain_c.setItemText(5, QCoreApplication.translate("DockWidget_psd", u"20000", None))
        self.comboBox_psd_gain_c.setItemText(6, QCoreApplication.translate("DockWidget_psd", u"50000", None))
        self.comboBox_psd_gain_c.setItemText(7, QCoreApplication.translate("DockWidget_psd", u"100000", None))

        self.pushButton_psd_reset_subchannel_c.setText(QCoreApplication.translate("DockWidget_psd", u"Reset", None))
        self.label_28.setText(QCoreApplication.translate("DockWidget_psd", u"Delay", None))
        self.label_psd_delay_range_c.setText(QCoreApplication.translate("DockWidget_psd", u"Range", None))
        self.comboBox_psd_delay_range_c.setItemText(0, QCoreApplication.translate("DockWidget_psd", u"0", None))
        self.comboBox_psd_delay_range_c.setItemText(1, QCoreApplication.translate("DockWidget_psd", u"1", None))
        self.comboBox_psd_delay_range_c.setItemText(2, QCoreApplication.translate("DockWidget_psd", u"2", None))
        self.comboBox_psd_delay_range_c.setItemText(3, QCoreApplication.translate("DockWidget_psd", u"3", None))

#if QT_CONFIG(tooltip)
        self.horizontalSlider_psd_delay_dac_c.setToolTip(QCoreApplication.translate("DockWidget_psd", u"Voltage Slider for PSD Delay DAC A", None))
#endif // QT_CONFIG(tooltip)
        self.text_psd_delay_dac_c.setInputMask(QCoreApplication.translate("DockWidget_psd", u"0.00 V", None))
        self.text_psd_delay_dac_c.setText(QCoreApplication.translate("DockWidget_psd", u"0.0 V", None))
        self.label_29.setText(QCoreApplication.translate("DockWidget_psd", u"Width", None))
        self.label_psd_width_range_c.setText(QCoreApplication.translate("DockWidget_psd", u"Range", None))
        self.comboBox_psd_width_range_c.setItemText(0, QCoreApplication.translate("DockWidget_psd", u"0", None))
        self.comboBox_psd_width_range_c.setItemText(1, QCoreApplication.translate("DockWidget_psd", u"1", None))
        self.comboBox_psd_width_range_c.setItemText(2, QCoreApplication.translate("DockWidget_psd", u"2", None))
        self.comboBox_psd_width_range_c.setItemText(3, QCoreApplication.translate("DockWidget_psd", u"3", None))

#if QT_CONFIG(tooltip)
        self.horizontalSlider_psd_width_dac_c.setToolTip(QCoreApplication.translate("DockWidget_psd", u"Voltage Slider for PSD Delay DAC A", None))
#endif // QT_CONFIG(tooltip)
        self.text_psd_width_dac_c.setInputMask(QCoreApplication.translate("DockWidget_psd", u"0.00 V", None))
        self.text_psd_width_dac_c.setText(QCoreApplication.translate("DockWidget_psd", u"0.0 V", None))
        self.groupBox_subchannel_B.setTitle("")
        self.label_24.setText(QCoreApplication.translate("DockWidget_psd", u"B", None))
        self.label_psd_gain_a_2.setText(QCoreApplication.translate("DockWidget_psd", u"Gain", None))
        self.comboBox_psd_gain_b.setItemText(0, QCoreApplication.translate("DockWidget_psd", u"500", None))
        self.comboBox_psd_gain_b.setItemText(1, QCoreApplication.translate("DockWidget_psd", u"1000", None))
        self.comboBox_psd_gain_b.setItemText(2, QCoreApplication.translate("DockWidget_psd", u"2000", None))
        self.comboBox_psd_gain_b.setItemText(3, QCoreApplication.translate("DockWidget_psd", u"5000", None))
        self.comboBox_psd_gain_b.setItemText(4, QCoreApplication.translate("DockWidget_psd", u"10000", None))
        self.comboBox_psd_gain_b.setItemText(5, QCoreApplication.translate("DockWidget_psd", u"20000", None))
        self.comboBox_psd_gain_b.setItemText(6, QCoreApplication.translate("DockWidget_psd", u"50000", None))
        self.comboBox_psd_gain_b.setItemText(7, QCoreApplication.translate("DockWidget_psd", u"100000", None))

        self.pushButton_psd_reset_subchannel_b.setText(QCoreApplication.translate("DockWidget_psd", u"Reset", None))
        self.label_25.setText(QCoreApplication.translate("DockWidget_psd", u"Delay", None))
        self.label_psd_delay_range_b.setText(QCoreApplication.translate("DockWidget_psd", u"Range", None))
        self.comboBox_psd_delay_range_b.setItemText(0, QCoreApplication.translate("DockWidget_psd", u"0", None))
        self.comboBox_psd_delay_range_b.setItemText(1, QCoreApplication.translate("DockWidget_psd", u"1", None))
        self.comboBox_psd_delay_range_b.setItemText(2, QCoreApplication.translate("DockWidget_psd", u"2", None))
        self.comboBox_psd_delay_range_b.setItemText(3, QCoreApplication.translate("DockWidget_psd", u"3", None))

#if QT_CONFIG(tooltip)
        self.horizontalSlider_psd_delay_dac_b.setToolTip(QCoreApplication.translate("DockWidget_psd", u"Voltage Slider for PSD Delay DAC A", None))
#endif // QT_CONFIG(tooltip)
        self.text_psd_delay_dac_b.setInputMask(QCoreApplication.translate("DockWidget_psd", u"0.00 V", None))
        self.text_psd_delay_dac_b.setText(QCoreApplication.translate("DockWidget_psd", u"0.0 V", None))
        self.label_26.setText(QCoreApplication.translate("DockWidget_psd", u"Width", None))
        self.label_psd_width_range_b.setText(QCoreApplication.translate("DockWidget_psd", u"Range", None))
        self.comboBox_psd_width_range_b.setItemText(0, QCoreApplication.translate("DockWidget_psd", u"0", None))
        self.comboBox_psd_width_range_b.setItemText(1, QCoreApplication.translate("DockWidget_psd", u"1", None))
        self.comboBox_psd_width_range_b.setItemText(2, QCoreApplication.translate("DockWidget_psd", u"2", None))
        self.comboBox_psd_width_range_b.setItemText(3, QCoreApplication.translate("DockWidget_psd", u"3", None))

#if QT_CONFIG(tooltip)
        self.horizontalSlider_psd_width_dac_b.setToolTip(QCoreApplication.translate("DockWidget_psd", u"Voltage Slider for PSD Delay DAC A", None))
#endif // QT_CONFIG(tooltip)
        self.text_psd_width_dac_b.setInputMask(QCoreApplication.translate("DockWidget_psd", u"0.00 V", None))
        self.text_psd_width_dac_b.setText(QCoreApplication.translate("DockWidget_psd", u"0.0 V", None))
        self.groupBox_subchannel_A.setTitle("")
        self.label_17.setText(QCoreApplication.translate("DockWidget_psd", u"A", None))
        self.label_psd_gain_a.setText(QCoreApplication.translate("DockWidget_psd", u"Gain", None))
        self.comboBox_psd_gain_a.setItemText(0, QCoreApplication.translate("DockWidget_psd", u"500", None))
        self.comboBox_psd_gain_a.setItemText(1, QCoreApplication.translate("DockWidget_psd", u"1000", None))
        self.comboBox_psd_gain_a.setItemText(2, QCoreApplication.translate("DockWidget_psd", u"2000", None))
        self.comboBox_psd_gain_a.setItemText(3, QCoreApplication.translate("DockWidget_psd", u"5000", None))
        self.comboBox_psd_gain_a.setItemText(4, QCoreApplication.translate("DockWidget_psd", u"10000", None))
        self.comboBox_psd_gain_a.setItemText(5, QCoreApplication.translate("DockWidget_psd", u"20000", None))
        self.comboBox_psd_gain_a.setItemText(6, QCoreApplication.translate("DockWidget_psd", u"50000", None))
        self.comboBox_psd_gain_a.setItemText(7, QCoreApplication.translate("DockWidget_psd", u"100000", None))

        self.pushButton_psd_reset_subchannel_a.setText(QCoreApplication.translate("DockWidget_psd", u"Reset", None))
        self.label_19.setText(QCoreApplication.translate("DockWidget_psd", u"Delay", None))
        self.label_psd_delay_range_a.setText(QCoreApplication.translate("DockWidget_psd", u"Range", None))
        self.comboBox_psd_delay_range_a.setItemText(0, QCoreApplication.translate("DockWidget_psd", u"0", None))
        self.comboBox_psd_delay_range_a.setItemText(1, QCoreApplication.translate("DockWidget_psd", u"1", None))
        self.comboBox_psd_delay_range_a.setItemText(2, QCoreApplication.translate("DockWidget_psd", u"2", None))
        self.comboBox_psd_delay_range_a.setItemText(3, QCoreApplication.translate("DockWidget_psd", u"3", None))

#if QT_CONFIG(tooltip)
        self.horizontalSlider_psd_delay_dac_a.setToolTip(QCoreApplication.translate("DockWidget_psd", u"Voltage Slider for PSD Delay DAC A", None))
#endif // QT_CONFIG(tooltip)
        self.text_psd_delay_dac_a.setInputMask(QCoreApplication.translate("DockWidget_psd", u"0.00 V", None))
        self.text_psd_delay_dac_a.setText(QCoreApplication.translate("DockWidget_psd", u"0.0 V", None))
        self.label_23.setText(QCoreApplication.translate("DockWidget_psd", u"Width", None))
        self.label_psd_width_range_a.setText(QCoreApplication.translate("DockWidget_psd", u"Range", None))
        self.comboBox_psd_width_range_a.setItemText(0, QCoreApplication.translate("DockWidget_psd", u"0", None))
        self.comboBox_psd_width_range_a.setItemText(1, QCoreApplication.translate("DockWidget_psd", u"1", None))
        self.comboBox_psd_width_range_a.setItemText(2, QCoreApplication.translate("DockWidget_psd", u"2", None))
        self.comboBox_psd_width_range_a.setItemText(3, QCoreApplication.translate("DockWidget_psd", u"3", None))

#if QT_CONFIG(tooltip)
        self.horizontalSlider_psd_width_dac_a.setToolTip(QCoreApplication.translate("DockWidget_psd", u"Voltage Slider for PSD Delay DAC A", None))
#endif // QT_CONFIG(tooltip)
        self.text_psd_width_dac_a.setInputMask(QCoreApplication.translate("DockWidget_psd", u"0.00 V", None))
        self.text_psd_width_dac_a.setText(QCoreApplication.translate("DockWidget_psd", u"0.0 V", None))
        self.pushButton_reset_psd.setText(QCoreApplication.translate("DockWidget_psd", u"Reset PSD", None))
        self.checkBox_psd_global_enable.setText(QCoreApplication.translate("DockWidget_psd", u"PSD Global Enable ", None))
#if QT_CONFIG(tooltip)
        self.label_psd_auto_veto_dac_2.setToolTip(QCoreApplication.translate("DockWidget_psd", u"<html><head/><body><p><span style=\" font-weight:700;\">Auto Veto Time: </span></p><p><br/></p><p>Configures the time at which the ASIC auto resets if the <span style=\" font-weight:700;\">Veto Reset(Take Event)</span> signal is not asserted.  </p><p>Inversely related to DAC voltage, not linear; Higher Voltage -&gt; Quicker reset.  </p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.label_psd_auto_veto_dac_2.setText(QCoreApplication.translate("DockWidget_psd", u"Auto Veto DAC voltage", None))
#if QT_CONFIG(tooltip)
        self.horizontalSlider_psd_auto_veto_dac.setToolTip(QCoreApplication.translate("DockWidget_psd", u"Voltage Slider for PSD Delay DAC A", None))
#endif // QT_CONFIG(tooltip)
        self.text_psd_auto_veto_dac.setInputMask(QCoreApplication.translate("DockWidget_psd", u"0.00 V", None))
        self.text_psd_auto_veto_dac.setText(QCoreApplication.translate("DockWidget_psd", u"0.0 V", None))
        self.groupBox_psd_offset_dac.setTitle(QCoreApplication.translate("DockWidget_psd", u"Offset DAC Config", None))
        self.label_33.setText(QCoreApplication.translate("DockWidget_psd", u"Channel", None))
        self.label_31.setText(QCoreApplication.translate("DockWidget_psd", u"B", None))
        self.label_32.setText(QCoreApplication.translate("DockWidget_psd", u"C", None))
        self.label_30.setText(QCoreApplication.translate("DockWidget_psd", u"A", None))
        self.pushButton_psd_offset_dac_configure.setText(QCoreApplication.translate("DockWidget_psd", u"Configure", None))
        self.pushButton_psd_offset_dac_reset.setText(QCoreApplication.translate("DockWidget_psd", u"Reset", None))
        self.verticalGroupBox.setTitle(QCoreApplication.translate("DockWidget_psd", u"Channel Enable ", None))
        self.checkBox_psd_channel_enable_10.setText(QCoreApplication.translate("DockWidget_psd", u"10", None))
        self.checkBox_psd_channel_enable_12.setText(QCoreApplication.translate("DockWidget_psd", u"12", None))
        self.checkBox_psd_channel_enable_0_7.setText(QCoreApplication.translate("DockWidget_psd", u"0-7", None))
        self.checkBox_psd_channel_enable_14.setText(QCoreApplication.translate("DockWidget_psd", u"14", None))
        self.checkBox_psd_channel_enable_11.setText(QCoreApplication.translate("DockWidget_psd", u"11", None))
        self.checkBox_psd_channel_enable_15.setText(QCoreApplication.translate("DockWidget_psd", u"15", None))
        self.checkBox_psd_channel_enable_4.setText(QCoreApplication.translate("DockWidget_psd", u"4", None))
        self.checkBox_psd_channel_enable_5.setText(QCoreApplication.translate("DockWidget_psd", u"5", None))
        self.checkBox_psd_channel_enable_3.setText(QCoreApplication.translate("DockWidget_psd", u"3", None))
        self.checkBox_psd_channel_enable_0.setText(QCoreApplication.translate("DockWidget_psd", u"0", None))
        self.checkBox_psd_channel_enable_2.setText(QCoreApplication.translate("DockWidget_psd", u"2", None))
        self.checkBox_psd_channel_enable_13.setText(QCoreApplication.translate("DockWidget_psd", u"13", None))
        self.checkBox_psd_channel_enable_9.setText(QCoreApplication.translate("DockWidget_psd", u"9", None))
        self.label_34.setText(QCoreApplication.translate("DockWidget_psd", u"Enable", None))
        self.checkBox_psd_channel_enable_7.setText(QCoreApplication.translate("DockWidget_psd", u"7", None))
        self.checkBox_psd_channel_enable_all.setText(QCoreApplication.translate("DockWidget_psd", u"All", None))
        self.checkBox_psd_channel_enable_8.setText(QCoreApplication.translate("DockWidget_psd", u"8", None))
        self.checkBox_psd_channel_enable_6.setText(QCoreApplication.translate("DockWidget_psd", u"6", None))
        self.checkBox_psd_channel_enable_8_15.setText(QCoreApplication.translate("DockWidget_psd", u"8-15", None))
        self.checkBox_psd_channel_enable_1.setText(QCoreApplication.translate("DockWidget_psd", u"1", None))
        self.pushButton_continous_octal_dac_update.setText(QCoreApplication.translate("DockWidget_psd", u"Continous Octal Dac Update", None))
        self.label_psd_polarity.setText(QCoreApplication.translate("DockWidget_psd", u"Polarity", None))
        self.comboBox_psd_polarity.setItemText(0, QCoreApplication.translate("DockWidget_psd", u"positive", None))
        self.comboBox_psd_polarity.setItemText(1, QCoreApplication.translate("DockWidget_psd", u"negative", None))

        self.label_psd_bias_2.setText(QCoreApplication.translate("DockWidget_psd", u"Bias", None))
        self.comboBox_psd_bias.setItemText(0, QCoreApplication.translate("DockWidget_psd", u"high", None))
        self.comboBox_psd_bias.setItemText(1, QCoreApplication.translate("DockWidget_psd", u"low", None))

        self.label_psd_trigger_mode.setText(QCoreApplication.translate("DockWidget_psd", u"Trigger Mode", None))
        self.comboBox_psd_trigger_mode.setItemText(0, QCoreApplication.translate("DockWidget_psd", u"3", None))
        self.comboBox_psd_trigger_mode.setItemText(1, QCoreApplication.translate("DockWidget_psd", u"2", None))
        self.comboBox_psd_trigger_mode.setItemText(2, QCoreApplication.translate("DockWidget_psd", u"1", None))

        self.label_35.setText(QCoreApplication.translate("DockWidget_psd", u"VTC Range", None))
        self.comboBox_psd_vtc_range.setItemText(0, QCoreApplication.translate("DockWidget_psd", u"250 ns", None))
        self.comboBox_psd_vtc_range.setItemText(1, QCoreApplication.translate("DockWidget_psd", u"2 us", None))

        self.groupBox_psd_test_mode.setTitle(QCoreApplication.translate("DockWidget_psd", u"PSD Test Mode", None))
        self.label_36.setText(QCoreApplication.translate("DockWidget_psd", u"Status", None))
        self.comboBox_psd_test_mode.setItemText(0, QCoreApplication.translate("DockWidget_psd", u"On", None))
        self.comboBox_psd_test_mode.setItemText(1, QCoreApplication.translate("DockWidget_psd", u"Off", None))

        self.label_38.setText(QCoreApplication.translate("DockWidget_psd", u"Test Sub Channel", None))
        self.comboBox_psd_test_mode_subchannel_selection.setItemText(0, QCoreApplication.translate("DockWidget_psd", u"A", None))
        self.comboBox_psd_test_mode_subchannel_selection.setItemText(1, QCoreApplication.translate("DockWidget_psd", u"B", None))
        self.comboBox_psd_test_mode_subchannel_selection.setItemText(2, QCoreApplication.translate("DockWidget_psd", u"C", None))

        self.pushButton_psd_test_mode_configure.setText(QCoreApplication.translate("DockWidget_psd", u"Configure", None))
        self.pushButton_psd_test_mode_reset.setText(QCoreApplication.translate("DockWidget_psd", u"Reset", None))
        self.label_37.setText(QCoreApplication.translate("DockWidget_psd", u"Test Channel", None))
        self.pushButton_reset_all_dacs.setText(QCoreApplication.translate("DockWidget_psd", u"Reset DACs", None))
        self.pushButton_reset_psd_ui.setText(QCoreApplication.translate("DockWidget_psd", u"Reset PSD GUI to last configured state", None))
    # retranslateUi
