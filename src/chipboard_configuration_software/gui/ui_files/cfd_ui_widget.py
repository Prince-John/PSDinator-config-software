...
class Ui_Widget_Cfd(object):
    def setupUi(self, Widget_Cfd):
        ...
        self.verticalGroupBox = QGroupBox(Widget_Cfd)
        ...
        self.gridLayout_4.addWidget(self.verticalGroupBox, 0, 1, 2, 2)

        self.groupBox_test_cfd = QGroupBox(Widget_Cfd)
        ...
        QMetaObject.connectSlotsByName(Widget_Cfd)
    # setupUi

    def retranslateUi(self, Widget_Cfd):
        Widget_Cfd.setWindowTitle(QCoreApplication.translate("Widget_Cfd", u"Form", None))
        self.groupBox_cfd_global_settings.setTitle(QCoreApplication.translate("Widget_Cfd", u"CFD Global Settings", None))
        self.label_4.setText(QCoreApplication.translate("Widget_Cfd", u"Nowlin Mode", None))
        self.checkBox_le_out_enable.setText(QCoreApplication.translate("Widget_Cfd", u"LE Out Enable", None))
        self.label_13.setText(QCoreApplication.translate("Widget_Cfd", u"AGND Trim", None))
        self.checkBox_negative_polarity.setText(QCoreApplication.translate("Widget_Cfd", u"Negative Polarity", None))
        self.comboBox_cfd_pulse_width.setItemText(0, QCoreApplication.translate("Widget_Cfd", u"50", None))
        self.comboBox_cfd_pulse_width.setItemText(1, QCoreApplication.translate("Widget_Cfd", u"100", None))
        self.comboBox_cfd_pulse_width.setItemText(2, QCoreApplication.translate("Widget_Cfd", u"200", None))
        self.comboBox_cfd_pulse_width.setItemText(3, QCoreApplication.translate("Widget_Cfd", u"500", None))

        self.label_6.setText(QCoreApplication.translate("Widget_Cfd", u"Lockout DAC", None))
        self.label_8.setText(QCoreApplication.translate("Widget_Cfd", u"Lockout Mode", None))
        self.comboBox_lockout_mode.setItemText(0, QCoreApplication.translate("Widget_Cfd", u"Short", None))
        self.comboBox_lockout_mode.setItemText(1, QCoreApplication.translate("Widget_Cfd", u"Long", None))
        self.comboBox_lockout_mode.setItemText(2, QCoreApplication.translate("Widget_Cfd", u"Disabled", None))

        self.label_9.setText(QCoreApplication.translate("Widget_Cfd", u"CFD Pulse Width", None))
        self.comboBox_agnd_trim.setItemText(0, QCoreApplication.translate("Widget_Cfd", u"1.36 V", None))
        self.comboBox_agnd_trim.setItemText(1, QCoreApplication.translate("Widget_Cfd", u"1.43 V", None))
        self.comboBox_agnd_trim.setItemText(2, QCoreApplication.translate("Widget_Cfd", u"1.49 V", None))
        self.comboBox_agnd_trim.setItemText(3, QCoreApplication.translate("Widget_Cfd", u"1.56 V", None))
        self.comboBox_agnd_trim.setItemText(4, QCoreApplication.translate("Widget_Cfd", u"1.63 V", None))
        self.comboBox_agnd_trim.setItemText(5, QCoreApplication.translate("Widget_Cfd", u"1.69 V", None))
        self.comboBox_agnd_trim.setItemText(6, QCoreApplication.translate("Widget_Cfd", u"1.77 V", None))
        self.comboBox_agnd_trim.setItemText(7, QCoreApplication.translate("Widget_Cfd", u"1.84 V", None))

        self.checkBox_cfd_global_enable.setText(QCoreApplication.translate("Widget_Cfd", u"CFD Global Enable", None))
        self.comboBox_nowlin_mode.setItemText(0, QCoreApplication.translate("Widget_Cfd", u"Short", None))
        self.comboBox_nowlin_mode.setItemText(1, QCoreApplication.translate("Widget_Cfd", u"Long", None))

        self.checkBox_global_mode.setText(QCoreApplication.translate("Widget_Cfd", u"Global Mode", None))
        self.label_5.setText(QCoreApplication.translate("Widget_Cfd", u"Nowlin Delay (ns)", None))
        self.verticalGroupBox.setTitle(QCoreApplication.translate("Widget_Cfd", u"Channel Enable ", None))
        self.label_34.setText(QCoreApplication.translate("Widget_Cfd", u"Enable", None))
        self.checkBox_cfd_channel_enable_8_15.setText(QCoreApplication.translate("Widget_Cfd", u"8-15", None))
        self.checkBox_cfd_channel_enable_0_7.setText(QCoreApplication.translate("Widget_Cfd", u"0-7", None))
        self.checkBox_cfd_channel_enable_all.setText(QCoreApplication.translate("Widget_Cfd", u"All", None))
        self.checkBox_cfd_channel_enable_4.setText(QCoreApplication.translate("Widget_Cfd", u"4", None))
        self.checkBox_cfd_channel_enable_14.setText(QCoreApplication.translate("Widget_Cfd", u"14", None))
        self.checkBox_cfd_channel_enable_6.setText(QCoreApplication.translate("Widget_Cfd", u"6", None))
        self.checkBox_cfd_channel_enable_8.setText(QCoreApplication.translate("Widget_Cfd", u"8", None))
        self.checkBox_cfd_channel_enable_13.setText(QCoreApplication.translate("Widget_Cfd", u"13", None))
        self.checkBox_cfd_channel_enable_2.setText(QCoreApplication.translate("Widget_Cfd", u"2", None))
        self.label_35.setText(QCoreApplication.translate("Widget_Cfd", u"Leading Edge DAC", None))
        self.checkBox_cfd_channel_enable_15.setText(QCoreApplication.translate("Widget_Cfd", u"15", None))
        self.checkBox_cfd_channel_enable_9.setText(QCoreApplication.translate("Widget_Cfd", u"9", None))
        self.checkBox_cfd_channel_enable_11.setText(QCoreApplication.translate("Widget_Cfd", u"11", None))
        self.checkBox_cfd_channel_enable_3.setText(QCoreApplication.translate("Widget_Cfd", u"3", None))
        self.checkBox_cfd_channel_enable_12.setText(QCoreApplication.translate("Widget_Cfd", u"12", None))
        self.checkBox_cfd_channel_enable_0.setText(QCoreApplication.translate("Widget_Cfd", u"0", None))
        self.checkBox_cfd_channel_enable_7.setText(QCoreApplication.translate("Widget_Cfd", u"7", None))
        self.checkBox_cfd_channel_enable_10.setText(QCoreApplication.translate("Widget_Cfd", u"10", None))
        self.checkBox_cfd_channel_enable_1.setText(QCoreApplication.translate("Widget_Cfd", u"1", None))
        self.checkBox_cfd_channel_enable_5.setText(QCoreApplication.translate("Widget_Cfd", u"5", None))
        self.groupBox_test_cfd.setTitle(QCoreApplication.translate("Widget_Cfd", u"CFD Test Settings", None))
        self.label_7.setText(QCoreApplication.translate("Widget_Cfd", u"Test Point Channel", None))
        self.comboBox_cfd_test_point.setItemText(0, QCoreApplication.translate("Widget_Cfd", u"AVSS", None))
        self.comboBox_cfd_test_point.setItemText(1, QCoreApplication.translate("Widget_Cfd", u"lockout pulse", None))
        self.comboBox_cfd_test_point.setItemText(2, QCoreApplication.translate("Widget_Cfd", u"leading edge detector pulse", None))
        self.comboBox_cfd_test_point.setItemText(3, QCoreApplication.translate("Widget_Cfd", u"zero crossing detector pulse", None))
        self.comboBox_cfd_test_point.setItemText(4, QCoreApplication.translate("Widget_Cfd", u"oneshot input", None))
        self.comboBox_cfd_test_point.setItemText(5, QCoreApplication.translate("Widget_Cfd", u"oneshot pulse", None))

        self.comboBox_cfd_test_point_channel.setItemText(0, QCoreApplication.translate("Widget_Cfd", u"0", None))
        self.comboBox_cfd_test_point_channel.setItemText(1, QCoreApplication.translate("Widget_Cfd", u"1", None))
        self.comboBox_cfd_test_point_channel.setItemText(2, QCoreApplication.translate("Widget_Cfd", u"2", None))
        self.comboBox_cfd_test_point_channel.setItemText(3, QCoreApplication.translate("Widget_Cfd", u"3", None))
        self.comboBox_cfd_test_point_channel.setItemText(4, QCoreApplication.translate("Widget_Cfd", u"4", None))
        self.comboBox_cfd_test_point_channel.setItemText(5, QCoreApplication.translate("Widget_Cfd", u"5", None))
        self.comboBox_cfd_test_point_channel.setItemText(6, QCoreApplication.translate("Widget_Cfd", u"6", None))
        self.comboBox_cfd_test_point_channel.setItemText(7, QCoreApplication.translate("Widget_Cfd", u"7", None))
        self.comboBox_cfd_test_point_channel.setItemText(8, QCoreApplication.translate("Widget_Cfd", u"8", None))
        self.comboBox_cfd_test_point_channel.setItemText(9, QCoreApplication.translate("Widget_Cfd", u"9", None))
        self.comboBox_cfd_test_point_channel.setItemText(10, QCoreApplication.translate("Widget_Cfd", u"10", None))
        self.comboBox_cfd_test_point_channel.setItemText(11, QCoreApplication.translate("Widget_Cfd", u"11", None))
        self.comboBox_cfd_test_point_channel.setItemText(12, QCoreApplication.translate("Widget_Cfd", u"12", None))
        self.comboBox_cfd_test_point_channel.setItemText(13, QCoreApplication.translate("Widget_Cfd", u"13", None))
        self.comboBox_cfd_test_point_channel.setItemText(14, QCoreApplication.translate("Widget_Cfd", u"14", None))
